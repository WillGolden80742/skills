...
## Mensagem
feat: skill configurar-espelhamento-server — espelhamento bidirecional generico SSH/SFTP

## Arquivos
- README.MD
- configurar-espelhamento-server/SKILL.md
- configurar-espelhamento-server/configurar_espelho.py

## Hash
f76e4ca51ff80a8f3c25419804d495007f0029ad

## Diff
diff --git a/README.MD b/README.MD
index a8f61cb..7541ce4 100644
--- a/README.MD
+++ b/README.MD
@@ -85,6 +85,11 @@ Quando uma mensagem do usuário casa com algum `trigger`, o OpenCode carrega o c
...
+
 ...
 | Skill | Descrição |
 |---|---|
diff --git a/configurar-espelhamento-server/SKILL.md b/configurar-espelhamento-server/SKILL.md
new file mode 100644
index 0000000..f52be33
--- /dev/null
+++ b/configurar-espelhamento-server/SKILL.md
@@ -0,0 +1,43 @@
+---
...
diff --git a/configurar-espelhamento-server/configurar_espelho.py b/configurar-espelhamento-server/configurar_espelho.py
new file mode 100644
index 0000000..90059e2
--- /dev/null
+++ b/configurar-espelhamento-server/configurar_espelho.py
@@ -0,0 +1,460 @@
+#!/usr/bin/env python3
