...
## Mensagem
feat: VPS_ prefix, extrai .sync_theme.py como referencia standalone
...
## Hash
1fbb116f36d6d1f1d6e84c5d16f2457360346472

## Diff
diff --git a/configurar-espelhamento-server/.sync_theme.py b/configurar-espelhamento-server/.sync_theme.py
new file mode 100644
index 0000000..3830fc1
--- /dev/null
+++ b/configurar-espelhamento-server/.sync_theme.py
@@ -0,0 +1,315 @@
+#!/usr/bin/env python3
+"""
...
index 90059e2..74a8289 100644
--- a/configurar-espelhamento-server/configurar_espelho.py
...
+set "VPS_REMOTE_HOST={host}"
+set "VPS_REMOTE_PORT={port}"
+set "VPS_REMOTE_USER={user}"
+set "VPS_REMOTE_BASE={remote_path}"
